	...
	<?php if (session()->has('error')): ?>
      ...
      <div class="screen">
        <div class="screen__content">
          <form class="login" action="<?php echo base_url();?>action_signup" method="post">
			...
			<div class="login__field">
              <i class="login__icon fas fa-lock"></i>
              <input type="password" class="login__input" name="password_confirm" placeholder="Confirm Password"  id="myInput">
